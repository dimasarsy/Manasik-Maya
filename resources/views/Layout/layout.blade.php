        ...
        <div class="container d-flex align-items-center justify-content-between">
            <div class="logo">
                <a href="/" class="d-flex justify-content-between align-items-center gap-4">
                    @if (Route::current()->getName() == 'level')
            ...
            <nav id="navbar" class="navbar">
                <ul class="center-navbar">
                    ...
                    <li><a class="nav-link scrollto {{ $active == 'level' ? 'active' : '' }}" href="/level">Levels</a>
                    </li>
                    <li><a class="nav-link scrollto {{ $active == 'marketplace' ? 'active' : '' }}"
                    ...
                    @auth
                        @if (Auth::user()->role->name == 'User')
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><a class="dropdown-item {{ $active == 'mySchedule' ? 'active' : '' }}"
                                            href="/mySchedule">My Schedule</a></li>
                                    <li><a class="dropdown-item {{ $active == 'pengajuan' ? 'active' : '' }}"
                                            href="{{ url('/pengajuan') }}">Pengajuan Muthawif</a></li>
                                    <li><a class="dropdown-item {{ $active == 'historyTransaction' ? 'active' : '' }}"
                                            href="/historyTransaction">Histori Transaksi</a></li>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li class="text-start px-2">
                                        <a href="/deleteAllNotification/{{ auth()->user()->id }}"
                                            class="text-decoration-none fw-bold" style="color: red; font-size: 12px;">Delete
                                            All
                                        </a>
                                    </li>
